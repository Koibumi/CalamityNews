...
- Xyk近期可能着手磁极异变(9/21)
  ![alt text](../Themed/Weapon_Rework/text_magnomally.jpg)
- 再之后可能着手星神之杀和耀界之光(9/21)
  ![alt text](../Themed/Weapon_Rework/text_exoWeapons.jpg)
  ![alt text](../Themed/Weapon_Rework/image_leviatitan.png)
- ENNWAY重做了回春环刃(9/23)
  ![alt text](../Themed/Weapon_Rework/image_terraDisk.png)
- ENNWAY称他之后还会着手元素飞盘的重做(9/23)
  ![alt text](../Themed/Weapon_Rework/text_elementalDisk.jpg)
- AngelVA称以后可能将一些消耗性盗贼武器重做成非消耗的(9/23)
  ![alt text](../Themed/Weapon_Rework/text_consumable.jpg)
...
- 老猪的二三阶段将有不同的贴图(9/9)  
  ...
  三阶段头和翅膀会被硫磺(核?)火焰烧化  
  ![alt text](../Themed/Old_Duke/text_oldDukeP2P3.jpg)
- 未知剧透(9/9)
  ![alt text](../Themed/Old_Duke/text_dialoguePanel.jpg)
...
- Triangle提到,Changelogs中提到的两种新生物Shroomble和Clad Crab都将是地表生物,其中后者与石板蟹相关(9/18)
  ![alt text](text_shroomble.png)
  ![alt text](text_cladCrab.jpg)
...
- 疑似是沉沦海的新敌怪(9/18)
  ![alt text](../Themed/SSO/image_fatFish.png)

# 硫磺海
## 硫磺海新背景(9/3)
![alt text](../Themed/Sulphur_Sea/image_sulfurSeaBackground.png)

## 生物
- Triangle捣碎鳄(9/21)
  ![alt text](../Themed/Sulphur_Sea/imgae_trasher.png)
...
- 雨云元素(9/22)
  ![alt text](../Themed/Resprites/image_HotECloud.png)
...
- Cristian Mihaii给元素系列武器的设计图(9/22)
  ![alt text](../Themed/Resprites/image_elemental.png)
- Triangle为湮灭千星绘制的新贴图(9/23)
  ![alt text](../Themed/Resprites/image_elementalBow.png)

# 新鞭子
- 计划中有7把新鞭子,分别是Rotten Maw, Ardor Blossom Star, Skycaller Lash(天蓝鞭),以及四把月后鞭子,分别为亵渎后,噬魂??后,神吞后和龙后,但是进度依然很落后
  ![alt text](../Themed/Summoner/text_whipOverview.jpg)
  ![alt text](../Themed/Summoner/text_whipProgression.jpg)
- 将会移除鞭子的暴击率,另外也可能会回调之前被削得很惨的鞭炮
  ![alt text](../Themed/Summoner/text_whipCrit.jpg)
...
## 金源套
![alt text](../Themed/Armor_Rework/image_auricTesla.png)
...
![alt text](../Themed/Armor_Rework/text_reaver.jpg)

# 其他
- 计划给宇宙锭和金源锭设计工具(9/2)
  ![alt text](../Themed/Others/text_tools.png)
- 沉沦海完成后可能会有永恒和亵渎迷你群落(9/21)
  ![alt text](../Themed/Others/text_minibiome.png)

# 花絮
- 开发者称卖玩偶的大部分收入都被厂家拿走了(9/13)
  ![alt text](text_fumo.jpg)
- 灾厄正式招募了艺术家Cristian Mihaii加入灾厄团队(9/15)  
  ![alt text](text_Mihaii.png)  
  下面是他的一些灾厄相关作品.  
  ![alt text](image_MihaiiExoTwins.png)  
  ![alt text](image_MihaiiCalamitas.png)  
  ![alt text](image_MihaiiDoG.png)  
  ![alt text](image_Drataliornus.png)  
  <video controls src="./video_MihaiiDragonWing.mp4" title="Title"></video>  
- 知名油管主(~~Re-Logic前CEO~~)Chippy表达了对灾厄玩偶的极度喜爱(9/17)
  ![alt text](image_chippy.png)